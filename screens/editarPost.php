    ...
    <form action="<?= ROOT_PATH ?>src/updatePost.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row offset-md-2">
            ...
            <div class="mb-3">
                ...
                <img src="../imgPosts/<?= $postagem ? $postagem["imagem_url"] : "" ?>" name="impPost" alt="" class="form-control" style="object-fit: scale-down; width: 450px; height: 250px;">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="imgName" value="<?= $postagem ? $postagem["imagem_url"] : "" ?>" hidden>
